/* Constraints, Sequ�ncias e �ndices
*
*

Objetivo: Trabalhar com constraints e entender o que s�o sequ�ncias e �ndices.
*/
...
-- Coluna 1: id_cliente do tipo INT          --> Chave Prim�ria
-- Coluna 2: nome_cliente do tipo VARCHAR2   --> N�o aceita valores nulos
-- Coluna 3: sexo do tipo VARCHAR2           --> N�o aceita valores nulos  
-- Coluna 4: email do tipo VARCHAR2          --> N�o aceita valores nulos
-- Coluna 5: cpf do tipo VARCHAR2            --> N�o aceita valores duplicados
-- Coluna 6: data_nascimento do tipo DATE    --> N�o tem restri��o
...
-- Coluna 1: id_produto do tipo INT            --> Chave Prim�ria
-- Coluna 2: nome_produto do tipo VARCHAR2     --> N�o aceita valores nulos
-- Coluna 3: marca do tipo VARCHAR2            --> N�o aceita valores nulos
-- Coluna 4: categoria do tipo VARCHAR2        --> N�o aceita valores nulos
-- Coluna 5: preco_unit do tipo NUMBER         --> N�o aceita valores nulos nem abaixo de zero
-- Coluna 6: custo_unit do tipo NUMBER         --> N�o aceita valores nulos nem abaixo de zero
-- Coluna 7: estoque do tipo INT               --> N�o aceita valores nulos nem abaixo de zero
...
-- Coluna 1: id_venda do tipo INT           --> Chave Prim�ria
-- Coluna 2: data_venda do tipo DATE        --> Valor Padr�o (sysdate) caso n�o seja preenchida
-- Coluna 3: id_cliente do tipo INT         --> Chave Estrangeira
-- Coluna 4: id_produto do tipo INT         --> Chave Estrangeira
-- Coluna 5: quantidade do tipo NUMBER      --> N�o aceita valores nulos
...
INSERT INTO produtos(id_produto, nome_produto, marca, categoria, preco_unit, custo_unit, estoque) VALUES
    (7,  'Smart TV 4K',   'LG', 'Televis�o', 1800, 700, 100);
INSERT INTO produtos(id_produto, nome_produto, marca, categoria, preco_unit, custo_unit, estoque) VALUES
    (8,  'Smart TV Crystal UHD 4K', 'Samsung', 'Televis�o', 3000, 1200, 100);
...
CYCLE | NOCYCLE       -- quando atinge o valor m�ximo, pode ou n�o voltar do come�o
CACHE n | NOCACHE;

*/

-- Crie uma sequ�ncia para o id_venda
...
-- Crie uma sequ�ncia para o id_produto
...
INSERT INTO clientes(id_cliente, nome_cliente, sexo, email, data_nascimento, cpf) VALUES
    (clientes_seq.NEXTVAL,  'Andr� Martins',   'M', 'andre.m@gmail.com', '12/02/1989', '839.283.190-00');
INSERT INTO clientes(id_cliente, nome_cliente, sexo, email, data_nascimento, cpf) VALUES
    (clientes_seq.NEXTVAL,  'B�rbara Campos',  'F', 'barb_campos@hotmail.com', '07/05/1992', '351.391.410-02');
INSERT INTO clientes(id_cliente, nome_cliente, sexo, email, data_nascimento, cpf) VALUES
...
INSERT INTO produtos(id_produto, nome_produto, marca, categoria, preco_unit, custo_unit, estoque) VALUES
    (produtos_seq.NEXTVAL,  'Smart TV 4K',   'LG', 'Televis�o', 1800, 700, 100);
INSERT INTO produtos(id_produto, nome_produto, marca, categoria, preco_unit, custo_unit, estoque) VALUES
    (produtos_seq.NEXTVAL,  'Smart TV Crystal UHD 4K', 'Samsung', 'Televis�o', 3000, 1200, 100);
...
-- 1. Se tivermos um ROLLBACK, as transa��es s�o desfeitas, mas o NEXTVAL n�o volta atr�s
-- 2. N�o utilize uma mesma sequ�ncia em mais de uma tabela
...
-- O que �?
-- Um �ndice se trata de um recurso do Banco de Dados que possibilita que uma consulta
