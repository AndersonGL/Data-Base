...
-- I. O que � CRUD e o que s�o os comandos DDL, DML e TCL.
...
Comandos para controle de transa��es em um banco de dados.
...
INSERT INTO clientes(id_cliente, nome_cliente, sexo, email, data_nascimento, cpf) VALUES
    (1,  'Andr� Martins',   'M', 'andre.m@gmail.com', '12/02/1989', '839.283.190-00');
INSERT INTO clientes(id_cliente, nome_cliente, sexo, email, data_nascimento, cpf) VALUES
    (2,  'B�rbara Campos',  'F', 'barb_campos@hotmail.com', '07/05/1992', '351.391.410-02');
INSERT INTO clientes(id_cliente, nome_cliente, sexo, email, data_nascimento, cpf) VALUES
...
INSERT INTO produtos(id_produto, nome_produto, marca, categoria, preco_unit, custo_unit) VALUES
    (7,  'Smart TV 4K',   'LG', 'Televis�o', 1800, 700);
INSERT INTO produtos(id_produto, nome_produto, marca, categoria, preco_unit, custo_unit) VALUES
    (8,  'Smart TV Crystal UHD 4K', 'Samsung', 'Televis�o', 3000, 1200);
...
-- V. DML UPDATE
-- Atualize o pre�o unit�rio do produto de ID = 1 para R$3900.
...
-- IX. DDL COMMENT
-- Crie coment�rios para tabelas e colunas do banco de dados.


-- 1) Na tabela produtos, crie o seguinte coment�rio: 'Informa��es de Produtos'.

DESC produtos;

COMMENT ON TABLE produtos
IS 'Informa��o de Produtos';

SELECT * FROM USER_TAB_COMMENTS;

-- Exclui um coment�rio na tabela
COMMENT ON TABLE produtos
IS '';


-- 2) Crie um coment�rio na coluna MARCA da tabela PRODUTOS: 'Descreve a categoria do produto'.
...
-- X. Comandos TCL
-- Utilize os comandos COMMIT, ROLLBACK e SAVEPOINT para controlar as transa��es.
...
INSERT INTO CLIENTES(ID_CLIENTE, NOME_CLIENTE, SEXO, EMAIL, DATA_NASCIMENTO) VALUES
    (2,  'B�rbara Campos',  'F', 'barb_campos@hotmail.com', '07/05/1992');
